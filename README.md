An e-commerce platform that allows users to browse products, add items to the cart, and place orders. The app also provides order history and product management for a smooth user and admin experience.
